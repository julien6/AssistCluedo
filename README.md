...
Document validation also checks visible metadata, plan/trace truth-mode alignment, mandatory and
forbidden facts, and document creation timestamps against the facts they express.
